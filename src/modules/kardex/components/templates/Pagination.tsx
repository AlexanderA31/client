...
export const PaginationControls = ({
	...
	const endItem = Math.min(pagination?.page * pagination?.limit, metaDataPagination?.totalItems || 0)
				...
				<div className='flex items-center justify-between'>
					<div className='flex items-center gap-3'>
						<Badge
							...
							{startItem}-{endItem} de {metaDataPagination?.totalItems || 0}
						</Badge>
					</div>
					...
					<Typography variant='muted'>
						{loading ? (
							...
							<>
								...
								<span>{metaDataPagination?.totalItems || 0}</span> elementos
							</>
						)}
					</Typography>
				</div>
